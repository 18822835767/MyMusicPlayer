package com.example.www11.mymusicplayer.main;
...
import com.example.www11.mymusicplayer.musiclist.MusicListFragment;
...
public class MainActivity extends AppCompatActivity implements HomePageFragment.OnHomePageListener,
        SongListFragment.OnSongListListener, MusicListFragment.OnMusicListener, SearchFragment.OnSearchListener {
    ...
    private MusicListFragment mMusicFragment = null;
        ...
        switch (index) {
            ...
            case SHOW_MUSIC:
                if (mMusicFragment == null) {
                    mMusicFragment = new MusicListFragment();
